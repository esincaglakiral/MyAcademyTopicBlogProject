...
builder.Services.AddAutoMapper(Assembly.GetExecutingAssembly());  //profiledan miras alan tüm sýnýflarýn registiration iþlemini yapmýþ olur
...
builder.Services.AddDbContext<TopicContext>(); //DbContext sýnýfýmýzý buraya veriyoruz
